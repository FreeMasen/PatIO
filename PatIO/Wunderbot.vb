...
'url(city, state)
'creates a query link using provided location
...
Public Class Wunderbot
    ...
    Public Property queryResults As ArrayList = New ArrayList

    'arraylist for returning information on a day by day basis
    Public Property weatherDay As ArrayList = New ArrayList
    ...
    Public Sub url(city As String, state As String)
        ...
        End If
        correcteCity = city
        queryurl = String.Format("http://api.wunderground.com/api/c5b2392f51a928de/forecast10day/q/{0}/{1}.xml", state.ToUpper, correcteCity)
    End Sub
